...
> `dob_ground_coef · ‖d−load‖²` on served `d=d_slow+d_fast` (**P103:** two-timescale DOB;
...
> FALSIFIED as det_r. **P103 EXIT:** two-timescale DOB KEEP as filter / FALSIFIED as champ. **P104 EXIT:** feat-fast **REVERT** (cannot attribute). **P102 EXIT:** increment MSE
...
- **Grounding (KalmanNet, P19)**: the recon innovation alone under-drives `d_t`
  ...
  `‖d−load‖²` on served `d=d_slow+d_fast` (**P103:** two-timescale DOB; **P102 EXIT:**
