...
> `dob_ground_coef · ‖Δd−Δload‖²` first-difference (**P102:** increment MSE;
...
> FALSIFIED as det_r. **P102:** increment MSE. `dob_reg_coef → 0` when
...
- **Grounding (KalmanNet, P19)**: the recon innovation alone under-drives `d_t`
  ...
  `‖Δd−Δload‖²` first-difference (**P102:** increment MSE; **P101 EXIT:** raw
  ...
  **P98 EXIT:** Wiener HP MSE **KEEP as P2-entry** / **FALSIFIED as amp recovery**
  ...
  raw MSE KEEP as K-hold / FALSIFIED as det_r (pred_std **1.086**; det_r **0.197**; paired **−19.10** 8/9; K **0.097** SS **≈2.04**); **P102:** increment MSE `‖Δd−Δload‖²`; so this
