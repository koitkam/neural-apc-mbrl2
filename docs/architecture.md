...
> (P77 LIVE A/B iter 52; RSSM via `DREAMER_WORLD_MODEL_TYPE=rssm`) continuous latent, compile **eager**, **DOB on** (GAIN-ONLY cont; `d_t` is the
...
> (LIVE P1 iter 52; probe50 H=1 r=+0.509 H=55 r=+0.273 conv=0
> gain_fid=0.389; recon best 0.006@52 ~2.3× P64; persist_rel 0.49
