...
> continues TSSM rest-IC KV (P78 EXIT FALSIFIED as GAIN-READY / KEEP as OL lift; pid **261143** last_ok **91** **4.08@MV**; val MV **×1.721** DV **×0.729**; OL-vs-real **×0.567**; RSSM `prev_state=None` identity). jsonl emits
