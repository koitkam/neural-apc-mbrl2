...
> rise-mass **REVERT**; P111 EXIT FALSIFIED as freeze — do not promote). Continues TSSM rest-IC KV (P78 EXIT FALSIFIED as
...
- **GAIN block** (`cont_gain_dim = n_cv·(n_mv+n_dv)`): inferred in-context from the
  ...
  **P74 EXIT REVERT:** decoder `gain_cv_skip` was a teacher-pin no-op
  ...
  Last-step DC Huber restored. **P111 EXIT INVALID:** rest-IC last DC KEEP +
