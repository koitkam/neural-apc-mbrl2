...
> (P77 EXIT Markovian rest-IC **FALSIFIED**; P78 LIVE P1 iter 62 rest-IC `prev_state=` probe60 H=55 **+0.440 conv=0 best_h=55**; recon **0.0041**; jsonl ×1 ≠ GAIN-READY; RSSM via `DREAMER_WORLD_MODEL_TYPE=rssm`) continuous latent, compile **eager**, **DOB on** (GAIN-ONLY cont; `d_t` is the
...
> conv=0; actor INVALID. **P78 LIVE** rest-IC `prev_state=` (`run_p78_prevkv`, pid **261143** P1 iter **62**; probe60 H=55 **+0.440 conv=0 best_h=55**; recon **0.0041**; jsonl ×1 ≠ GAIN-READY).
...
> continues TSSM rest-IC KV (P78 LIVE pid **261143** P1 iter **62**; RSSM `prev_state=None` identity). jsonl emits
