...
> (P77 EXIT Markovian rest-IC **FALSIFIED**; P78 LIVE P1 iter 74 rest-IC `prev_state=` probe70 H=55 **+0.308 conv=0 best_h=13**; recon **0.0024** new best; jsonl ×1 ≠ GAIN-READY; RSSM via `DREAMER_WORLD_MODEL_TYPE=rssm`) continuous latent, compile **eager**, **DOB on** (GAIN-ONLY cont; `d_t` is the
...
> conv=0; actor INVALID. **P78 LIVE** rest-IC `prev_state=` (`run_p78_prevkv`, pid **261143** P1 iter **74**; probe70 H=55 **+0.308 conv=0 best_h=13**; recon **0.0024** new best; jsonl ×1 ≠ GAIN-READY).
...
> continues TSSM rest-IC KV (P78 LIVE pid **261143** P1 iter **74**; RSSM `prev_state=None` identity). jsonl emits
