...
> (P77 EXIT Markovian rest-IC **FALSIFIED**; P78 LIVE 2nd extra-P1 after extra-P1@94 FAIL **0.45@MV / 0.74@DV**; last_ok **91 locked** wrap@92; orig-P1 **1.99@MV**; probe90 H=55 **+0.159 conv=0**; jsonl ×1 ≠ 5-level TM; RSSM via `DREAMER_WORLD_MODEL_TYPE=rssm`) continuous latent, compile **eager**, **DOB on** (GAIN-ONLY cont; `d_t` is the
...
> conv=0; actor INVALID. **P78 LIVE 2nd extra-P1** after extra-P1@94 FAIL **0.45@MV / 0.74@DV** (`run_p78_prevkv`, pid **261143** last_ok **91 locked**; probe90 H=55 **+0.159 conv=0**; jsonl ×1 ≠ 5-level).
...
> continues TSSM rest-IC KV (P78 LIVE 2nd extra-P1 pid **261143** extra-P1@94 FAIL **0.45@MV**; last_ok **91 locked**; RSSM `prev_state=None` identity). jsonl emits
