...
> FALSIFIED as det_r. **P103 EXIT:** two-timescale DOB KEEP as filter / FALSIFIED as champ. **P104 LIVE:** feat-fast **REVERT** on HEAD. **P102 EXIT:** increment MSE
...
- **Feedforward (Scope 2, shipped 2026-06-11)**: `d_t` is appended to `feat`
  ...
  **REVERT**; P105 identity = P103 served `d`). `d` is **detached** into `feat`
  (the DOB is
