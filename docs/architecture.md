...
> `dob_ground_coef · ‖d−load‖²` on **raw** tensors (**P101:** skip HP crop-demean;
...
> HP crop-demean crushed K **0.119→0.049**). **P101:** raw MSE ground. `dob_reg_coef → 0` when
...
- **Grounding (KalmanNet, P19)**: the recon innovation alone under-drives `d_t`
  ...
  `‖d−load‖²` on **raw** tensors (**P101:** skip HP crop-demean; **P89:** high-pass MA
  ...
  **P98 EXIT:** Wiener HP MSE **KEEP as P2-entry** / **FALSIFIED as amp recovery**
  ...
  paired **−8.72**; FALSIFIED as champ / TM; HP crushed K **0.119→0.049**); **P101 LIVE P3@290:**
  raw MSE held K **0.097@136** SS **≈2.04** (P100 **0.049** / **≈1.04**); rscale **1.99 KEEP**; val amp still pending; so this
