...
- **GAIN block** (`cont_gain_dim = n_cv·(n_mv+n_dv)`): inferred in-context from the
  ...
  **P77 EXIT FALSIFIED** Markovian rest-IC; **P78 EXIT FALSIFIED**
  KV-continue as GAIN-READY (KEEP as OL lift; last_ok **91** **4.08@MV**; val MV **×1.721 / ×1.710** DV **×0.729 / ×0.624**; 1step→OL **×0.857**; det_r **0.010**). TSSM family closed. Env-free default **rssm** (opt-in `DREAMER_WORLD_MODEL_TYPE=tssm`). **P79 EXIT** KEEP rssm / **FALSIFIED as P64-identity** (GAIN-READY **0.81@DV** last_ok **81**; val MV **×0.923 / ×0.953** DV **×0.781 / ×0.838**; paired **−10.57 vs −82.79** VALID 9/9). **P80 LIVE** persist 0.1→0.0 pid **293761** P2 after orig-P1 **GAIN-READY 0.86@MV / 0.87@DV** last_ok **82** (weaker than P64 0.91@DV; actor VALID). probe80 H=55 **+0.563 conv=0.50**; probe90 H=55 **+0.489 conv=0.50**; probe100 H=55 **+0.355 conv=0.50**; probe110 (frozen g) H=55 **+0.541 conv=0.50** best_h **55**; probe120 H=55 **+0.553 conv=0.50** best_h **55**. skip-storm **1/2 @45**. Champion **P64**.
  Explicit
