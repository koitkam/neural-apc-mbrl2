...
> (P77 LIVE A/B iter 75; RSSM via `DREAMER_WORLD_MODEL_TYPE=rssm`) continuous latent, compile **eager**, **DOB on** (GAIN-ONLY cont; `d_t` is the
...
> (LIVE P1 iter 75; probe70 H=1 r=+0.746 beat P64; H=55 r=+0.160 collapsed conv=0
> gain_fid=0.537 best_h=27 — do not treat as health; recon best 0.0033@73 ≈ P64;
> persist 0.57@70 → 0.040@75; wrap 0.147@56 recovered skip 0; CPU @wm_best70 Markovian |Δ|=0.256 1step→OL ×0.272 (iter50 0.123 / ×0.097) — no live patch).
