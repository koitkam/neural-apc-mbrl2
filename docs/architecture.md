...
- **GAIN block** (`cont_gain_dim = n_cv·(n_mv+n_dv)`): inferred in-context from the
  ...
  **P74 EXIT REVERT:** decoder `gain_cv_skip` was a teacher-pin no-op
  ...
  stays last-only). Not P75 rise-mass. orig-P1@82 FAIL last-ok 81
  0.77@MV / @H 0.55; extra-P1 last_ok stays locked (P40); do not
  retune last_ok mid-run. **P76 EXIT REVERT:** RSSM GRU
