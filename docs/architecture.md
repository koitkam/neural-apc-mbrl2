...
> conv=0; actor INVALID. **P78 EXIT FALSIFIED** KV-continue as GAIN-READY (`run_p78_prevkv`, pid **261143**, 158 iters): last_ok **91** **4.08@MV / 0.72@DV**; val MV **×1.721 / ×1.710** DV **×0.729 / ×0.624**; 1step→OL **×0.857** OL-vs-real **×0.567**; det_r **0.010** pred_std **2.45 vs 1.93**; actor INVALID. TSSM family closed; env-free default **rssm**. **P79 LIVE P2** (`run_p79_rssmrevert`, pid **277462**): orig-P1 @82 **GAIN-READY 0.81@DV** last_ok **81** (actor VALID; weaker than P64 **0.91@DV**). Probe80 H=55 **+0.555 conv=0.50**. Probe90 **+0.431 / 0.50**. Probe100 **+0.376 / 0.75**. Probe110 **+0.384 / 0.50**. Probe120 H=55 **+0.514 conv=0**. Graph released; g FROZEN. Do **not** score actor until val. Do **not** launch a second GPU job.
