...
> conv=0; actor INVALID. **P78 EXIT FALSIFIED** KV-continue as GAIN-READY (`run_p78_prevkv`, pid **261143**, 158 iters): last_ok **91** **4.08@MV / 0.72@DV**; val MV **×1.721 / ×1.710** DV **×0.729 / ×0.624**; 1step→OL **×0.857** OL-vs-real **×0.567**; det_r **0.010** pred_std **2.45 vs 1.93**; actor INVALID. TSSM family closed; env-free default **rssm**. **P79 EXIT** KEEP rssm / **FALSIFIED as P64-identity** (`run_p79_rssmrevert`, pid **277462**, 204 iters): GAIN-READY **0.81@DV** last_ok **81**; val MV **×0.923 / ×0.953** DV **×0.781 / ×0.838**; 1step→OL **×0.840**; paired **−10.57 vs −82.79** VALID 9/9 loses to P64 **−4.54**. **P80 LIVE** persist 0.1→0.0 pid **293761** P3 after orig-P1 **GAIN-READY 0.86@MV / 0.87@DV** last_ok **82** (weaker than P64 0.91@DV; actor VALID). probe80 H=55 **+0.563 conv=0.50**; probe90 H=55 **+0.489 conv=0.50**; probe100 H=55 **+0.355 conv=0.50**; probe110 (frozen g) H=55 **+0.541 conv=0.50** best_h **55**; probe120 H=55 **+0.553 conv=0.50** best_h **55**; probe130 (frozen g) H=55 **+0.410 conv=0.50** best_h **55**. **P2→P3 @136 PASS** mtp **0.941** no p3-skip; first P3 ent **−0.172@137**; unfreeze 147 HELD **−0.101**. skip-storm **1/2 @45**. Champion **P64**. Hourly cron must **not** start a second GPU job.
