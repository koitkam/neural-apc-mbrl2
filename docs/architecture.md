...
> (LIVE P1 iter 40; probe40 H=1 r=+0.554 H=55 r=+0.267 conv=0
> gain_fid=0.524 best_h=1/55; recon best 0.0125 ~5× P64; persist_rel
> 0.181@40; CPU @wm_best40 Markovian |Δ|=0.14 1step→OL ×0.077 —
> no live patch).
