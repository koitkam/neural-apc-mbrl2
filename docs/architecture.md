...
> (P77 LIVE A/B iter 55; RSSM via `DREAMER_WORLD_MODEL_TYPE=rssm`) continuous latent, compile **eager**, **DOB on** (GAIN-ONLY cont; `d_t` is the
...
> (LIVE P1 iter 55; probe50 H=1 r=+0.509 H=55 r=+0.273 conv=0
> gain_fid=0.389; recon best 0.0057@53 ~2.2× P64; persist_rel 0.11@55
> after 0.73@51 inject; CPU @wm_best50 Markovian |Δ|=0.123 1step→OL ×0.097 — no live patch).
