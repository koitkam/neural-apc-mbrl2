...
> (P77 EXIT Markovian rest-IC **FALSIFIED**; P78 LIVE extra-P1 iter 86 after orig-P1 FAIL **1.99@MV / 0.71@DV** @82; probe80 H=55 **+0.314 conv=0**; jsonl ×1 ≠ 5-level TM; RSSM via `DREAMER_WORLD_MODEL_TYPE=rssm`) continuous latent, compile **eager**, **DOB on** (GAIN-ONLY cont; `d_t` is the
...
> conv=0; actor INVALID. **P78 LIVE extra-P1** after orig-P1 FAIL **1.99@MV / 0.71@DV** (`run_p78_prevkv`, pid **261143** iter **86**; probe80 H=55 **+0.314 conv=0**; jsonl ×1 ≠ 5-level).
...
> continues TSSM rest-IC KV (P78 LIVE extra-P1 pid **261143** iter **86** orig-P1 FAIL **1.99@MV**; RSSM `prev_state=None` identity). jsonl emits
