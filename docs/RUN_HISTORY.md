...
| P53 | 2026-08-30 | P3 PPO ratio clip vs frozen unfreeze-μ (`p3_mu_ratio_clip=0.2`) | LIVE `126f011` pid **75966** tmux `mbrl2_p53`. Step 4 `p3_sglogstd=True p3_logpclip=8 p3_muratio=0.2`. Watch unfreeze 147: unclipped logp_std ~0.5 and mvv warmup-class (~16k), not 813k. | 🔬 LIVE |
