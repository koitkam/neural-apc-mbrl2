...
| Rest-IC `rollout_observed` stacks unused `(N,L,F)` + Stage-1 `(N,L,n_cv)` zeros | P45 GPU-occupied | SUPERSEDED (`last_only=True`; HEAD, not pid 16548) | YES — rest-IC only needs last state; GRU recurrence identical; smoke last ≡ `stack[:, -1]` |
