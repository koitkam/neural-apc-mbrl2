...
| P59 | 2026-08-31 | env-free HEAD collect/val CUDA-graph + P3 warmup (knobs = P58) | LIVE P1 ~iter 25 identity vs P58 (recon 0.0032 vs 0.0039; gmatch ×1; `t_wm` 99.9 vs 102 s). Graph rest-ic **captured N=6 T=128**. `device=cuda`. `[resolved-cfg] … gmatch_rest_L=128 p3_muratio=0.2 p3_murefresh=0 compile=eager`. No leftover `DREAMER_*`. | LIVE |
