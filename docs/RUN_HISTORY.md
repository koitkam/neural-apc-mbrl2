...
| P67 | 2026-09-01 | teacher `gain_match_len` auto = `wm_tf_horizon` (K=220; encode T lookback) | LIVE extra-P1 iter **94** pid **187753** sha `9fbede0`. Storm **1/2 @67** recovered. Gate **82 FAIL 0.80@DV**; gate **94 FAIL 0.79@DV** (MV **1.11/@H 1.22**). Teacher ×1.01 at K=220. P64 first-gate **PASS 0.91@DV**. | 🔬 compounding: jsonl ×1 ≠ TM DC; extra-P1 not pinning DV |
...
### p67 (`run_p67_gmatch4h`, branch `cursor/p28`) — LIVE: teacher FD K = `wm_tf_horizon`
...
| Gain-match FD K = control H (last-only Huber) | P26–P66; val TM / decomp at `wm_tf_horizon=4H` | P67 auto K = `wm_tf_horizon` (LIVE pid **187753** extra-P1 iter **94**) | PARTIAL as protocol (jsonl ×1 at K=220) / looking **FALSIFIED as TM-DC pin** (pending EXIT). Gate **82 FAIL 0.80@DV** vs P64 **PASS 0.91@DV**; extra-P1 gate **94 FAIL 0.79@DV** MV **1.11/@H 1.22**. @H DV 0.97–0.99 healthy. jsonl ×1 ≠ TM ss. Storm 1/2 @67 recovered. Not S=H. Not a Huber reweight. Do not teacher-K N+1. |
