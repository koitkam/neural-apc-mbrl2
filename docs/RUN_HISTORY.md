...
| P42 | 2026-08-28 | last-ok lock after silent recon spike (20×) | LIVE P2 iter 111; freeze restored last_ok 66; freeze probe 0.75@DV | ⏳ GPU |
...
- **Liveness (11:58 CDT):** LIVE **P2** iter **111**. tmux `mbrl2_p42`, pid **4192010**, launch `72f7b48`. Isolation=0; no leftover `DREAMER_*`. **Lock KEEP as mechanism** (20× fire). last_ok **66 locked** through freeze. Skip-storm unlock untested. Wrap 5–10× untested (jump 170×). **<5× overwrite-prevention untested** — extra-P1 recon never dropped below 5× best (min **0.0255** = 14× at iter 104).
...
- **P2 GPU-confirmed last_ok class:** iter 105–111 recon **0.0022–0.0027** (iter 66 was 0.0022; extra-P1 104 was 0.0255), gmatch **0** (g frozen), **dobg 0.002–0.0035 live**, zrank ~887/1024 alive 1024. Fidelity iter 110 gain_fid **0.645** (extra-P1 probes were ~0.14–0.20). **Leave P2.** Val (MV+DV ss/@H, det_r vs P41 **0.079** / P40 **0.490** / P26 **0.68**) is the remaining freeze-66 vs P41 freeze-104 test. **No second GPU job.**
