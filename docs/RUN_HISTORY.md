...
| P58 | 2026-08-31 | env-free rest-IC encode L=lookback (`gain_match_rest_ic_len=0`) + HEAD graph T=128 | LAUNCH after P57 REVERT. Actor freeze-forever. No leftover `DREAMER_*`. Watch capture T=128 (or eager like P56) + val TM vs P53 ×0.90 / P56 ×0.76 + paired −13/−98. | LIVE |
...
- **Liveness (P1 ~iter 14, ~05:50 CDT):** pid **126332** alive, tmux `mbrl2_p58`, GPU **13632 MiB**. skip **0**. recon **0.0066**. Teacher FD MV/DV **×0.980 / ×1.010**. `t_wm` median **102 s** (P57 T=55 graph **99 s**; P56 eager T=128 **124 s** — lookback graph hides extra T). Probe iter 10 `gain_fid=0.853` `wm_best` saved. Do not launch a second GPU job.
- **Watch:** val TM vs P53 ×0.90 / P56 ×0.76; paired −13/−98. Do not attack compounding on this pid.
