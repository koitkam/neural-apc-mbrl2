...
- **Liveness:** **P2.** GPU occupied (~15.7 GB). tmux `mbrl2_p43`, pid **4465**, launch `51b0f45`. Iter **104 CAPPED GAIN_NOT_READY 0.75@DV** (MV ×1.06); freeze last_ok **94** probe **0.76@DV / MV ×1.02**. `huber_per_in=True`. **Do not launch a second GPU job.**
