...
| P71 | 2026-09-02 | gain-c decoder/feat only — not in GRU / TSSM token (P70 hold REVERT) | LIVE `run_p71_nogainc` pid **208659** sha `5a16c67`. P1 iter **24**. Storm **1/2 @5** restored last_ok **4**. Teacher pin @7 ×1.006/×0.923. Wrap lock@22 unlock@24. Probe20 `best_h=55/55` gain_fid **0.706**. Iter 24 teacher ×0.991/×1.034 skip 0. Not P70 detonation. | 🔬 LIVE |
...
### p71 (`run_p71_nogainc`, branch `cursor/p28`) — LIVE: gain-c out of GRU
...
- **LIVE (2026-09-02 00:52, P1 iter 24):** Storm **1/2 @iter 5** (recon 1.30, DV **×−6.54**, gnorm **1.4e11**, skip **77**) restored last_ok **4**. Teacher **pinned by iter 7** MV **×1.006 / DV ×0.923** (P68 pin @8; P70 never pinned). Recon **0.0039** @21. Probe@20 `best_h=55/55` gain_fid **0.706** (not H=1 noise). Wrap lock@**22** (recon 0.116 > 20× 0.0039) unlock@**24** (recon 0.044) — P68-class wrap recovery. Iter 24 teacher **×0.991 / ×1.034** gmatch 0.0004 skip 0 gnorm 0.88. **Not P70 detonation.** Watch freeze vs P64 **0.91@DV**; val 1step→OL / OL-vs-real vs P64 ×0.85/×0.84. `actor_experiment_valid`. jsonl ×1 ≠ val TM. **No second GPU job.**
...
| Gain-c decoder/feat only (not in GRU / TSSM token; `recurrence_c_dim=cont_dist_dim`) | **P71 LIVE** (`run_p71_nogainc`, pid **208659**, sha `5a16c67`) | LIVE | P1 iter **24**. Storm 1/2 @5 recovered (not P70 storm 2/2). Teacher pin @7. Wrap lock@22 unlock@24. Probe20 `best_h=55/55` gain_fid 0.706. Dist-c still a state. Env-free `cont_dist_dim=0` ⇒ GRU sees `[z, a, dv]`. No new knob. Watch freeze vs P64 0.91@DV. |
