...
| P51 | 2026-08-30 | P3 REINFORCE stop-grad log_std (`p3_stop_grad_log_std=True`) | **LIVE P3** iter **315** (~3h53). pid **54815**, launch `d6a4511`. Gate **GAIN-READY** 0.86@MV / 0.88@DV @82; last_ok **82 unlocked**. P2→P3 PASS 0.922 @136. First P3 ent **−0.125**. Unfreeze **147**: ent **HELD −0.141→−0.101** (not P50 −0.268). By **315**: ent **−0.282** (σ_min ≈−0.283; first <−0.25 @294 / <−0.27 @298 — rail geometry, delayed vs P50 instant yank); actor **±200**, gnorm **1444**, mvv **591k**, rtgt **0.0001**, ret_w **−2116**, ret_ema **−2243**. rscale freeze **2.17 KEEP**. Env-free. Do not launch. | 🔬 stop-grad KEEP as unfreeze-yank block; **failing as cascade / durable-σ lever**. Watch ES. Do not stack critic knobs. |
...
- **Cascade @315 (~3h53, still LIVE):** actor **+246 / −200** @312–313, gnorm **1444**; `actor_logp_std` 27–162; bc ~1.6–2.0; mvv **591k** @311; rtgt **0.0001**; ret_w **−2116**; ret_ema **−2243**. Entropy first <−0.25 @**294**, <−0.27 @**298**, last **−0.282** @315 (σ_min ≈ **−0.283**). Collapse is **delayed ~150 P3 iters** vs P50's instant unfreeze yank — tanh-rail geometry with frozen σ, not log_std training. rscale freeze **2.17 KEEP**. last_ok **82 unlocked**. ES window (30 iters, 70% below floor) is filling — EXIT likely soon.
- **Watch:** EXIT / ES. Do not edit val stack while pid 54815 is live. Do **not** launch. Do **not** implement the next μ-rail fix until EXIT.
...
| P3 REINFORCE stop-grad log_std (μ-only) | P51 LIVE P3 (`run_p51_sglogstd`, `d6a4511`) | KEEP as unfreeze-yank block (147: −0.141→−0.101); **not yet EXIT** as cascade lever | PARTIAL — delayed collapse: first <−0.25 @294, **−0.282** @315 (σ_min ≈−0.283) via μ-rail, not log_std grad. By 315: actor ±200, gnorm 1444, mvv 591k, rtgt 0.0001, ret_w −2116. rscale 2.17 KEEP. Do not stack critic knobs. Do not promote `p3_reset_log_std`. |
