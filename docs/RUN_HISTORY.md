...
| P59 | 2026-08-31 | env-free HEAD collect/val CUDA-graph + P3 warmup (knobs = P58) | LIVE P1. Graph rest-ic **captured N=6 T=128**. `device=cuda`. `[resolved-cfg] … gmatch_rest_L=128 p3_muratio=0.2 p3_murefresh=0 compile=eager`. No leftover `DREAMER_*`. | LIVE |
