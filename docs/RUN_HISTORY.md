...
| P71 | 2026-09-02 | gain-c decoder/feat only — not in GRU / TSSM token (P70 hold REVERT) | LIVE `run_p71_nogainc` pid **208659** sha `5a16c67`. Step 4: `device=cuda` `gmatch_len=55` `gmatch_ol_tail=0` rest-pre KEEP isolation=0 GAIN-ONLY. Iter 1 teacher ×0.654/×−1.14 skip 0 recon 0.093 gnorm 0.37 `t_wm` 93 s ~11 GB. Iter 2 skip 0 gnorm 0.50 (not P70 7.95 / ×−3.57). | 🔬 LIVE |
...
| Gain-c decoder/feat only (not in GRU / TSSM token; `recurrence_c_dim=cont_dist_dim`) | **P71 LIVE** (`run_p71_nogainc`, pid **208659**, sha `5a16c67`) | LIVE | — Compounding was G fading through `h`; P70 hold kept G in recurrence and detonated. Dist-c still a state. Env-free `cont_dist_dim=0` ⇒ GRU sees `[z, a, dv]`. No new knob. Step 4 CONFIRMED `gmatch_ol_tail=0` GAIN-ONLY. Iter 1 ×0.654/×−1.14 skip 0. Watch freeze vs P64 0.91@DV. |
