...
- Watch freeze vs P64 **0.91@DV** / P73 **0.83**; val **1step→OL / OL-vs-real** vs P73 ×0.761 / ×0.743 and P64 ×0.85 / ×0.84; jsonl `gain_cv_skip_rms` (0 at init, 0.0006 after iter 1); persist_rel still live; `actor_experiment_valid`.
