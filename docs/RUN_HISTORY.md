...
| Rest-IC last_only T-loop sequential kernel launches × 100 WM steps | P54 GPU-occupied; **P55/P56** capture failed; **P57 EXIT** pid **116788** | KEEP (`gain_match_rest_ic_cuda_graph=True`; `_RestICGraphModule`) | YES — **P57 captured** `N=6 T=55` then released. `t_wm` **99 s** vs P56 eager 124 s. Next: lookback T=128 on this graph surface (P58). |
