...
| P49 | 2026-08-29 | original-P1 wrap last-ok unlock | LIVE **P2** @83. Gate **GAIN-READY** @82 worst **0.82@MV** (MV 0.82/@H 0.84, DV 0.88/@H 0.94). last_ok **82** unlocked (not P48's 24). Skip-storm 1/2 @64–65 unlocked; wrap-unlock untested. `wm_best` 80. No detonated-freeze. | 🔬 freeze-24 confound in test (late-P1 freeze); do not launch |
...
- **Live (2026-08-29 ~15:26 CDT, pid 41994, launch `4ef9bcb`):** **P2** iter 83 (`g` frozen, dobg 0.0057). Gate **PASS GAIN-READY** @iter 82: DC [0.82, 0.88] @H [0.84, 0.94] worst **0.82@MV** (MV 0.82/@H 0.84, DV 0.88/@H 0.94); recent_max 6.613@80; p1_ext 0/175924. last_ok **82** `locked=False` — **not** P48 freeze-24. **Skip-storm 1/2 @64–65:** lock recon 0.3668=246×, restored last-ok 64, **`unlocked after skip-storm restore`**, last_ok then advanced. Wrap-recovery unlock **still untested** (P48-class recovered wrap without skip-storm). **No detonated-freeze** (recon 0.0060 vs best 0.0015, 4× < 5×). `wm_best` iter **80** (gain_fid 0.913); warm-restore SKIPPED (skip-storm recovered). Probe 80: H=55 r=+0.558. Teacher FD ~×1 (not TM). If P3 still cascades → freeze-24 was not the actor confound. **Do not launch.** HEAD leftover (not this pid): pin-eval + identified τ + **OBJECTIVE_*/OBJ_AUTO_*** TrainConfig.
...
| Last-ok original-P1 wrap never unlocks | P48 freeze (`run_p48_collectdv` pid 34706) | SUPERSEDED (original-P1 wrap recovery unlock; extra-P1 stay locked) | YES — live gate 0.89@DV @82; freeze restored 24 → 0.81@DV. Recon recovered iter 26 (0.009) but lock persisted. Skip-storm already unlocked; wrap recovery did not. Do not raise lock_ratio. |
