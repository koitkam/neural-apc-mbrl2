...
| P77 | 2026-09-03 | env-free `world_model_type='tssm'` (P76 z-bias REVERT) | LIVE **extra-P1 iter 91**. Orig-P1 @82 **FAIL −1.06@MV**. Probe90 **H=1 r=+0.592 / H=55 r=+0.147 conv=0.00** gain_fid **0.859** best_h=1 (H=55 collapsed 0.423→0.147). recon **0.0027@90 new best**. persist **0.029@91** (dv-prbs @90 did **not** spike; same as @70). Teacher **×1.00 / ×1.02 @91**. pid **242511**. | 🔬 LIVE extra-P1 — conv **0 @10–90**; H=55 dead again. Do not treat gain_fid 0.859 as health. Do not score actor. |
...
- **LIVE extra-P1 iter 91 (~479 min, nvidia 11.7 GB, `t_wm` ~306 s, sps 26.8 after inject):** skip **0**. recon **0.0027@90 new best → 0.0033@91**. Teacher jsonl 89 **×0.997 / ×1.046** → 90 **×1.004 / ×0.961** → 91 **×0.996 / ×1.022**. last_ok **91 unlocked**. persist_rel **0.030@90 → 0.029@91** after dv-prbs-only inject @90 — **collapsed, not a spike** (same as @70 0.57→0.08; unlike delayed 0.212@85 after full inject @80). Do **not** persist N+1. No extra-P1 re-probe yet. No detonated-freeze. Rest-IC graph not captured. Extra-P1 +75396 steps (to 829356, cap 929884). Next extra-P1 gate typically ~92–94 (P76 live @94). Next probe typically iter 100.
