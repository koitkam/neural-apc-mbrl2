...
- **P1 iter 57 (~129 min):** recon **0.0022** (best **0.0019@55**, beat 0.0024@51 / 0.0027@37) last_ok **57 unlocked** skip **0**. Iter 56 bump 0.0042 is 2.2× not lock. lock@38 wrap-unlock@39 last_ok advanced through recovery (P50-class KEEP). Iter 50 wm-fid H=55 r=**0.289** `gain_fid=0.714` best_h=13/55 (did not beat iter 30 EMA **5.798**). Teacher FD mv **1.00** / dv **0.996**. Gate 82 ~55 min; unfreeze ~147 is the A/B.
