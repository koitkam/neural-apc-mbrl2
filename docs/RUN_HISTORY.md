...
| P77 | 2026-09-03 | env-free `world_model_type='tssm'` (P76 z-bias REVERT) | LIVE **P1 iter 1**. Step 4: `wm=tssm` `gru_zbias=0` GAIN-ONLY `gmatch_len=55` rest-IC graph **not captured**. Teacher **×0.643 / ×−1.07** persist_rel **0.448** recon **0.806** skip **0**. pid **242511**. | 🔬 LIVE P1 — watch freeze vs P64 0.91@DV; conv>0; 1step→OL |
...
- Watch freeze vs P64 **0.91@DV**; conv>0 (P76 uniquely 0); val **1step→OL** vs P64 ×0.85 / P76 ×0.770; `actor_experiment_valid`. Do **not** start a second GPU job.
