...
| P58 | 2026-08-31 | env-free rest-IC encode L=lookback (`gain_match_rest_ic_len=0`) + HEAD graph T=128 | LIVE **P3** ~iter 194. Storm **2/2 @61** CAPPED extra P1. **GAIN-READY** last-ok **59** worst **0.85@DV** (MV ×1.23/@H ×1.25; freeze re-probe **0.84@DV**). Graph **released**. P3 unfreeze **126** (P3@116, warmup 10). ent **−0.107…−0.18** (not σ_min). logp_std held ~0.62 after 126–131 spike 3.22. rscale **2.41 KEEP**. rtgt 0.065→**0.002**. clip 0.65→0.11. critic_r **+0.96**. Watch val TM vs P53 ×0.90 / P56 ×0.76. | LIVE |
