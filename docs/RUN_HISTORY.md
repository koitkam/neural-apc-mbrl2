...
| Gain-match FD from PRBS posterior (no held settle) | P26–P43 | SUPERSEDED (HEAD `gain_match_settle_len` auto=control H; P44 GPU) | YES — Huber~0 at excited IC; TM rest-step 0.75@DV. Identified G = TM real. DV @H ×0.849 vs ss ×0.740 (4H compounding); MV @H≈ss. P44 tests S=H prior-hold, not TM `S=4H` encode-from-real-rest. |
