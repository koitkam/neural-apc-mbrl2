...
| P77 | 2026-09-03 | env-free `world_model_type='tssm'` (P76 z-bias REVERT) | LIVE **P1 iter 20**. Probe20 **H=1 r=+0.325 / H=55 r=+0.145 conv=0.00** gain_fid **0.261** best_h=0/55 (P76 +0.589/+0.543 conv=0 0.644; P64 +0.706/+0.498 conv=0.50 0.734). Probe10 was +0.128/+0.122/0.476. Iter19 wrap-like recon **0.497** teacher **×1.30 / ×−3.35** recovered @20 skip **0**. recon_best **0.129@18**. pid **242511**. | 🔬 LIVE P1 — conv=0 @10 **and** @20 (P76-class; P64/P73/P75 all 0.50@20). H=55 r still dead. Watch freeze vs P64 0.91@DV |
