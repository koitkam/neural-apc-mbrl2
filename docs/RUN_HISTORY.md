...
| P77 | 2026-09-03 | env-free `world_model_type='tssm'` (P76 z-bias REVERT) | LIVE **P1 iter 31**. Probe30 **H=1 r=+0.403 / H=55 r=+0.172 conv=0.00** gain_fid **0.387** best_h=1/55. recon **0.033@30 best** (P64 @30 **0.0034**; ~10×). Teacher **×0.995 / ×1.000 @30**. CPU: Markovian vs cached CV gap **0.18**. pid **242511**. | 🔬 LIVE P1 — H=1 at floor; H=55 dead; **conv=0 @10/20/30**. Do not patch live. |
...
- **LIVE P1 iter 31 (~163 min, nvidia 11.7 GB, `t_wm` ~306 s, sps 19.7):** skip **0**. Teacher jsonl 28 **×0.972 / ×1.154** → 29 **×0.996 / ×1.114** → 30 **×0.995 / ×1.000** (pinned) → 31 **×0.979 / ×1.027**. recon **0.034@28 → 0.033@30 new best → 0.035@31** vs P64 **0.0034@30** (~10×; P76 @30 recon 0.085 spike). last_ok **31 unlocked**. persist_rel **0.36@30 → 0.40@31**. Rest-IC graph not captured. Next probe typically iter 40.
