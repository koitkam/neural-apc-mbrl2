...
| P52 | 2026-08-30 | P3 REINFORCE logp clip (`p3_logp_clip=8` per action dim) | **LIVE P1** iter **61** (~138 min). pid **64705**, launch `d910ee2`. Step 4 **CONFIRMED** `p3_sglogstd=True p3_logpclip=8`. recon **0.0022** (new best **0.0017@60**) last_ok **61 unlocked** skip **0**. lock@38 wrap-unlock@39. Iter 60 probe H=55 r=0.216 gain_fid=0.693 best_h=27 (did not beat iter 30 EMA 5.798). GPU ~11 GB. Env-free. Watch gate 82; unfreeze ~147 vs P51 μ-rail. | 🔬 wrap-unlock KEEP. Do not launch. Do not stack critic knobs. |
...
- **P1 iter 61 (~138 min):** recon **0.0022** (new best **0.0017@60**, beat 0.0019@55) last_ok **61 unlocked** skip **0**. lock@38 wrap-unlock@39 last_ok advanced through recovery (P50-class KEEP). Iter 60 wm-fid H=55 r=**0.216** `gain_fid=0.693` best_h=27/55 (did not beat iter 30 EMA **5.798**; H=55 r down vs 0.289@50). Teacher FD mv **0.997** / dv **1.001**. Gate 82 ~46 min; unfreeze ~147 is the A/B.
