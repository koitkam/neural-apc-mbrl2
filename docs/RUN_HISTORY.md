...
| P52 | 2026-08-30 | P3 REINFORCE logp clip (`p3_logp_clip=8`) | **LIVE P1** `run_p52_logpclip` tmux `mbrl2_p52` pid **64705**, launch `d910ee2`. Step 4 **CONFIRMED** `p3_sglogstd=True p3_logpclip=8`. GPU ~11 GB. Env-free. Watch unfreeze ~147 vs P51 μ-rail. | 🔬 μ-side clamp after P51 cascade FALSIFIED. Do not launch. Do not stack critic knobs. |
...
- **Watch:** unfreeze ~147: ent stays ≈ H(σ_init); unclipped `actor_logp_std` may jump; actor_loss / rtgt / mvv should **not** P51-rail (147 logp_std 38 / actor −4.66 / later mvv 19k→681k). Do not launch a second GPU job. Do not edit val stack while pid 64705 is live.
