...
| P77 | 2026-09-03 | env-free `world_model_type='tssm'` (P76 z-bias REVERT) | LIVE **P1 iter 40**. Probe40 **H=1 r=+0.554 / H=55 r=+0.267 conv=0.00** gain_fid **0.524** best_h=1/55. recon **0.0125@39 best** (P64 @40 **0.0027**; ~5×). Teacher **×1.00 / ×0.99 @40**. persist_rel **0.035@39 → 0.181@40**. pid **242511**. | 🔬 LIVE P1 — H=1 above floor; H=55/conv still dead. Do not patch live. |
...
- **LIVE P1 iter 40 (~210 min, nvidia 11.7 GB, `t_wm` ~309 s, sps 19.5):** skip **0**. Teacher jsonl 38 **×1.012 / ×0.975** → 39 **×0.999 / ×1.033** → 40 **×0.997 / ×0.985** (pinned). recon **0.014@38 → 0.0125@39 new best → 0.0134@40** vs P64 **0.0027@40** (~5×; P76 @40 0.0033; P73 0.0026). last_ok **40 unlocked**. persist_rel **0.035@39 → 0.181@40** (rebound at inject/probe iter; P73-class). Rest-IC graph not captured. Probe 40 is current fidelity.
