...
| P78 | 2026-09-03 | TSSM gain-match rest-IC continues KV via `prev_state=` (P77 Markovian FALSIFIED) | LIVE P1 iter **6**. Teacher **×1.000 / ×0.980** persist **0.783** recon **0.423** skip **0**. @5 DV **×1.445** then recovered. persist 0.26→0.78 rebound. pid **261143**. | 🔬 LIVE — jsonl ×1 ≠ freeze. persist volatile vs P77. probe@10 next. Do not score actor. |
