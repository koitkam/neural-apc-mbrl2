...
| P58 | 2026-08-31 | env-free rest-IC encode L=lookback (`gain_match_rest_ic_len=0`) + HEAD graph T=128 | LIVE **P2**. Storm **2/2 @61** CAPPED extra P1. **GAIN-READY** last-ok **59** worst **0.85@DV** (MV ×1.23/@H ×1.25; freeze re-probe **0.84@DV**). Graph **released**. wm_best restore SKIPPED (gain-blind). P2 recon ~0.009. Watch val TM vs P53 ×0.90 / P56 ×0.76. | LIVE |
...
- **Liveness (P2 ~iter 64, ~07:17 CDT):** pid **126332** alive, tmux `mbrl2_p58`, GPU **13632 MiB**. Graph **captured** T=128 then **released** at g freeze. `t_wm` P1 median **102 s**. skip-storm **1/2 @58** then **2/2 @61** CAPPED extra P1 (608780 steps). **GAIN-READY** last-ok **59** worst **0.85@DV** (MV ×1.23/@H ×1.25 DV ×0.85/@H ×0.92); detonated-freeze re-probe **0.84@DV**. wm_best restore SKIPPED (gain-blind @iter30). P2 recon **~0.009** dobg **~0.009** skip 0/136. Probe@40 `gain_fid=0.537` no wm_best; @60 `0.934` best_h=1/55 (correlation-led). Do not launch a second GPU job.
- **Watch:** val TM vs P53 ×0.90 / P56 ×0.76; paired −13/−98. Live 0.85@DV is GAIN-READY-band, weaker than P57 0.89 / P54 0.91 — do not treat as observer win until val TM. Do not attack compounding on this pid. Extra P1 closed (P37 extra-P1 FALSIFIED).
