...
| P72 | 2026-09-02 | restore gain-c in GRU / TSSM token (`recurrence_c_dim=cont_dim`; P71 REVERT) | LIVE `run_p72_gaingru` pid **212027** sha `b009a7e`. Step 4 CONFIRMED `device=cuda` `gmatch_len=55` `gmatch_ol_tail=0` GAIN-ONLY. Iter 1 teacher ×0.668/×−1.23 skip 0 (P68-class, not P70). | 🔬 LIVE |
...
- **LIVE (2026-09-02 02:07, P1 iter 1):** teacher **×0.668 / ×−1.23** skip 0 recon 0.094 (P68-class; P70 never pinned). Watch freeze vs P64 **0.91@DV**; not P70 −0.60. jsonl ×1 ≠ val TM. **No second GPU job.**
