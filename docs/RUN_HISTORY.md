...
| P77 | 2026-09-03 | env-free `world_model_type='tssm'` (P76 z-bias REVERT) | LIVE **extra-P1 iter 85**. Orig-P1 @82 **FAIL GAIN_NOT_READY −1.06@MV** noisy sign-flip. EXTEND +75396. Probe80 **H=1 r=+0.583 / H=55 r=+0.423 conv=0**. recon **0.0029@85 new best**. persist **0.030@83 → 0.212@85** (delayed spike 5 iters after full inject @80). Teacher **×0.99 / ×1.07 @85**. pid **242511**. | 🔬 LIVE extra-P1 — orig-P1 miss vs P64 **0.91@DV**. Do not score actor. Do not persist N+1. Do not patch live. |
...
- **LIVE extra-P1 iter 85 (~447 min, nvidia 11.7 GB, `t_wm` ~311 s, sps 19.4):** skip **0**. recon **0.0029@85 new best** (beats 0.0032@78). Teacher jsonl 83 **×1.002 / ×0.976** → 84 **×0.998 / ×1.014** → 85 **×0.988 / ×1.073**. last_ok **85 unlocked**. persist_rel **0.030@83 → 0.035@84 → 0.212@85** — delayed spike **5 iters after** full inject @80 (not next-iter like 0.82@41 / 0.73@51 / 0.59@62; do **not** persist N+1). No extra-P1 re-probe @85. No detonated-freeze. Rest-IC graph not captured. Extra-P1 +75396 steps (to 829356, cap 929884). Next extra-P1 gate typically ~92–94 (P76 live @94). Next probe typically iter 90 (~03:18 CDT).
