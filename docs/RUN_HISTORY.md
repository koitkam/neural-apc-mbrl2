...
| P77 | 2026-09-03 | env-free `world_model_type='tssm'` (P76 z-bias REVERT) | LIVE **P1 iter 47**. Probe40 **H=1 r=+0.554 / H=55 r=+0.267 conv=0.00** gain_fid **0.524**. recon **0.007@47 best** (P64 @47 **0.0029**; ~2.6×). Teacher **×0.96 / ×1.22 @47**. persist_rel **0.27@46 → 0.50@47** (re-spike). pid **242511**. | 🔬 LIVE P1 — recon gap ~2.6×. persist re-spike + DV overgain. Probe 50 soon. Do not patch live. |
...
- **LIVE P1 iter 47 (~246 min, nvidia 11.7 GB, `t_wm` ~308 s, sps 19.6):** skip **0**. Teacher jsonl 45 **×1.008 / ×0.911** → 46 **×1.002 / ×0.968** → 47 **×0.963 / ×1.224** (DV overgain). recon **0.011@45 → 0.008@46 → 0.007@47 new best** vs P64 **0.0029@47** (~2.6×). last_ok **47 unlocked**. persist_rel **0.273@45 → 0.267@46 → 0.502@47** (re-spike with gmatch 0.009). Rest-IC graph not captured. Probe 40 still last fidelity. Next typically iter 50 (~15 min).
