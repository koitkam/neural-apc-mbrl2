...
| P76 | 2026-09-02 | RSSM GRU update-gate bias `log(H/16)` (~1.23; no new knob) | LIVE. Step 4 `gru_zbias=1.23` device=cuda. Iter 1 teacher ×0.463/×−1.32 skip 0. pid **237453** sha `0ddc372`. | 🔬 LIVE — compounding attack on `h`. No second GPU job. |
...
- Watch freeze vs P64 **0.91@DV** / P75 **0.84@MV**; skip-storm (keep-h can stall dynamics); val 1step→OL vs P64 ×0.85 / P75 ×0.80; `actor_experiment_valid`. Do **not** start a second GPU job.
