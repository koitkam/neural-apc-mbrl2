...
| P77 | 2026-09-03 | env-free `world_model_type='tssm'` (P76 z-bias REVERT) | LIVE **P1 iter 78**. Probe70 still last **H=1 r=+0.746 / H=55 r=+0.160 conv=0.00** gain_fid **0.537** best_h=27. recon **0.0032@78 new best** (P64 @70 **0.0035**). Teacher **×1.00 / ×1.07 @78** (DV blip **×1.21@76** recovered). persist_rel **0.57@70 → 0.036@78**. CPU @wm_best70 1step→OL **×0.272** Markovian |Δ| **0.256**. pid **242511**. | 🔬 LIVE P1 — recon beat P64; persist collapsed; H=55/conv still dead **@10–70**. Do not patch live. |
...
- **LIVE P1 iter 78 (~407 min, nvidia 11.7 GB, `t_wm` ~308 s, sps 19.6):** skip **0**. recon **0.0032@78 new best** (beats **0.0033@73** and P64 **0.0035@70**). Teacher jsonl 76 **×0.970 / ×1.210** (DV blip, gmatch 0.007) → 77 **×0.998 / ×1.009** → 78 **×0.996 / ×1.065**. last_ok **78 unlocked**. persist_rel **0.040@75 → 0.038@76 → 0.040@77 → 0.036@78** (still collapsed after dv-prbs inject; do **not** persist N+1). Rest-IC graph not captured. Next probe typically iter 80 (~02:27 CDT).
