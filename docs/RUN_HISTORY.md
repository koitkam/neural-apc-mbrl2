...
| P77 | 2026-09-03 | env-free `world_model_type='tssm'` (P76 z-bias REVERT) | LIVE **extra-P1 iter 88**. Orig-P1 @82 **FAIL GAIN_NOT_READY −1.06@MV** noisy sign-flip. EXTEND +75396. Probe80 **H=1 r=+0.583 / H=55 r=+0.423 conv=0**. recon **0.0029@87 best**. persist **0.212@85 → 0.033@88** (delayed spike decayed). Teacher **×1.01 / ×0.97 @88**. pid **242511**. | 🔬 LIVE extra-P1 — orig-P1 miss vs P64 **0.91@DV**. Do not score actor. Do not persist N+1. Do not patch live. |
...
- **LIVE extra-P1 iter 88 (~459 min, nvidia 11.7 GB, `t_wm` ~307 s, sps 19.6):** skip **0**. recon **0.0029@85 → 0.0036@86 → 0.0029@87 new best → 0.0030@88**. Teacher jsonl 85 **×0.988 / ×1.073** → 86 **×1.001 / ×1.022** → 87 **×0.998 / ×0.979** → 88 **×1.011 / ×0.969**. last_ok **88 unlocked**. persist_rel **0.212@85 → 0.053@86 → 0.048@87 → 0.033@88** — delayed spike decayed (do **not** persist N+1). No extra-P1 re-probe. No detonated-freeze. Rest-IC graph not captured. Extra-P1 +75396 steps (to 829356, cap 929884). Next extra-P1 gate typically ~92–94 (P76 live @94). Next probe typically iter 90 (~03:19 CDT).
