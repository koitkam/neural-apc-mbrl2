...
| P52 | 2026-08-30 | P3 REINFORCE logp clip (`p3_logp_clip=8` per action dim) | **LIVE P2** iter **100** (~194 min). pid **64705**, launch `d910ee2`. Gate **GAIN-READY** @82 last-ok **78**: MV **0.95/@H 0.95** DV **0.84/@H 0.89**. lock@79 wrap@81; freeze last_ok **78**. P2 recon **0.0022** bc MSE **0.004** skip **0**. `wm_best` EMA **6.184@90**; wm-fid 100 H=55 r=0.377 gain_fid=0.584 (no new best). Unfreeze ~147 (~21 min). | 🔬 last-ok probe GPU-confirmed. Do not launch. |
...
- **P2 iter 100 (~194 min):** recon **0.0022** bc MSE **0.004** skip **0** last_ok **78 unlocked** dobg ~0.003. Iter 90 wm-fid H=55 r=0.447 **gain_fid=0.989** `wm_best` EMA **6.184**. Iter 100 wm-fid H=55 r=0.377 best_h=27 **gain_fid=0.584** (no new best). t_iter ~27 s. Unfreeze ~147 (~21 min, 47 iters).
