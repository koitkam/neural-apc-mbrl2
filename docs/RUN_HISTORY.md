...
| P54 | 2026-08-30 | ES entropy thr = σ-band frac (`early_stop_entropy_collapse_floor_frac=0.25`) | LIVE env-free `run_p54_esentband`. One attributed change vs P53: 0.20-nat floor margin SUPERSEDED (P53 thr −0.083 < H(σ_max) −0.101). New thr ≈ −0.238. Watch ES ≠ entropy_collapse; P3 continues to p3_plateau. | LIVE |
