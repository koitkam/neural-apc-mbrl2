...
- **P1 iter 22 (LIVE, ~55 min, GPU 17745 MiB):** gmatch **0.0008** iso 0.0024 ss 0.0014 recon **0.0043** skip **0** (P37-class; P38 was stuck gmatch 1.30). Iter 17 gmatch 0.0016. P37 iter-19 wrap blip (recon 0.267 / gmatch 1.07) **did not fire**. Watch skip 0 through 53; iter 75 DV ratio toward [0.8, 1.3]. If storm 2/2 early: cube-boost FALSIFIED → REVERT `wm_isolation_dcv_match=False`. Do not launch a second GPU job.
...
| Isolation |ΔCV| excitation with **scale floor 1.0** | P39 LIVE (`run_p39_isodcvfloor`, `92c7662`, pid 4170377) | IN FLIGHT (default ON) | PARTIAL — P38 EXIT falsified shrink-the-strong-channel. Floor keeps P37 MV SNR. Iter 22 gmatch **0.0008** skip 0 (P37-class). Watch skip through 53. |
