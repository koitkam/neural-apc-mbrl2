...
| P52 | 2026-08-30 | P3 REINFORCE logp clip (`p3_logp_clip=8` per action dim) | **LIVE P2** iter **91** (~189 min). pid **64705**, launch `d910ee2`. Gate **GAIN-READY** @82 last-ok probe **78**: MV **0.95/@H 0.95** DV **0.84/@H 0.89** (worst 0.84@DV). lock@79 wrap-unlock@81; freeze restored last_ok **78**. P2 recon ~0.002 bc MSE 0.002 skip 0. Iter 90 `wm_best` EMA **6.184** (beat 5.863@70) gain_fid=0.989. Watch unfreeze ~147 vs P51 μ-rail. | 🔬 last-ok probe GPU-confirmed. Do not launch. |
...
- **P2 iter 91:** recon **0.0019** bc MSE **0.004** (P50-class, not NLL) skip **0** last_ok **78 unlocked** dobg ~0.002. Iter 90 wm-fid H=55 r=0.447 **gain_fid=0.989** new `wm_best` EMA **6.184** (beat 5.863@70). t_iter ~27 s.
