...
| Gain-match FD K = control H (last-only Huber) | P26–P66; val TM / decomp at `wm_tf_horizon=4H` | P67 auto K = `wm_tf_horizon` (next) | PARTIAL as protocol gap — 1-step faithful / OL short of plant (P64 ×0.842; P66 ×0.718). Not S=H. Not a Huber reweight. |
