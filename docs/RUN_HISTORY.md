...
| P59 | 2026-08-31 | env-free HEAD collect/val CUDA-graph + P3 warmup (knobs = P58) | LIVE **P3**. Storm **2/2 @76 CAPPED** original P1. Gate **GAIN-READY** last_ok **76** **0.88@DV / 0.97@MV**. Serve graph **captured**. Unfreeze **143** ent **−0.123 HELD**. rscale **2.35 FREEZE KEEP**. rtgt 0.040→**0.0015** (P58-class). logp_std **~0.54**. clip 0.50→**0.11**. Steady `t_collect` **1.87 s** vs P58 **4.18 s**; `t_ac` **1.83 s** vs P58 **3.52 s**. P2 recon **0.0018**. `t_wm` P1 **99.4 s** / P2 **21.9 s**. **No second GPU job.** | LIVE |
