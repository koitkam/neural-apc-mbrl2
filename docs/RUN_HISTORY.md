...
| P61 | 2026-08-31 | env-free cube-clip + realized Δu for gain-match FD | LAUNCH `run_p61_clipdu`. One attributed change vs P60: Huber `/` applied Δu; reverse-before-reclip on cube shrink. Isolation still off. μ-ratio 0.2. Serve graph KEEP. HEAD caches ride along (speed). | LAUNCH |
...
### p61 (`run_p61_clipdu`, branch `cursor/p28`) — LAUNCH: cube-clip + realized Δu for gain-match FD
