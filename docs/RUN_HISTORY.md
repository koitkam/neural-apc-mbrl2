...
- **Step 4 (pre-launch):** `[resolved-cfg] held_cv=True p1amp=0.2 p2amp=1 p3amp=1 compile=eager`. `[held-rollout] decode-CV stationarity (P62; not GRU h; P63 magnitude REVERT)`. Watch P1 recon ~0.002 skip 0 GAIN-READY (if skip-storm/GAIN_NOT_READY, held revert failed). P2 `dob_d_absmean` ↑ vs P62 ~0.03. Val pred_std vs 1.93; det_r vs P62 0.364 / P26 0.68; TM vs P26/P62. Do **not** score actor unless GAIN-READY.
