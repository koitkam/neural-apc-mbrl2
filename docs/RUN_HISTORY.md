...
- **HEAD (not in pid 126332):** P3 fused encode + collect/val CUDA-graph serve + P3 warmup under bf16 autocast. **Next GPU: P59** env-free identity of that HEAD (`run_p59_headserve`). Watch `t_collect`/`t_ac` vs P58 4.2/3.5 s; TM/econ ≈ P58.
