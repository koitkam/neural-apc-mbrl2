...
| P49 | 2026-08-29 | original-P1 wrap last-ok unlock | LIVE **P2** @94. Gate **GAIN-READY** @82 worst **0.82@MV** (MV 0.82/@H 0.84, DV 0.88/@H 0.94). last_ok **82** unlocked (not P48's 24). Skip-storm 1/2 @64–65 unlocked; wrap-unlock untested. `wm_best` **90**. No detonated-freeze. | 🔬 freeze-24 confound in test (late-P1 freeze); do not launch |
...
- **Live (2026-08-29 ~15:32 CDT, pid 41994, launch `4ef9bcb`):** **P2** iter 94 (`g` frozen, dobg 0.0053, rmtp 0.97). Gate **PASS GAIN-READY** @iter 82: DC [0.82, 0.88] @H [0.84, 0.94] worst **0.82@MV** (MV 0.82/@H 0.84, DV 0.88/@H 0.94); recent_max 6.613@80; p1_ext 0/175924. last_ok **82** `locked=False` — **not** P48 freeze-24. Freeze skipped reload so **live 82 ≈ gate** (DV 0.88, not P48 freeze 0.81). **Skip-storm 1/2 @64–65:** lock recon 0.3668 ≈184× best 0.0020, restored last-ok 64, **`unlocked after skip-storm restore`**, last_ok then advanced 66→82. Wrap-recovery unlock **still untested** (P48-class recovered wrap without skip-storm). **No detonated-freeze** (recon 0.0060 vs best 0.0015, 4× < 5×). `wm_best` iter **90** (gain_fid 0.923); warm-restore SKIPPED (skip-storm recovered). Probe 90: H=55 r=+0.557. Teacher FD ~×1 (not TM). P2→P3 typically ~iter 134–136. If P3 still cascades → freeze-24 was not the actor confound. **Do not launch.** HEAD leftover (not this pid): pin-eval + identified τ + **OBJECTIVE_*/OBJ_AUTO_*** TrainConfig (`bbdc153`).
