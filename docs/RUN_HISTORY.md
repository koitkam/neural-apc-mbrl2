...
- **LIVE (2026-08-29 20:04 CDT, extra-P1 iter 96):** wrap-unlock ×2 GPU-confirmed (56→58, 70→73). **bc MSE never NLL.** skip 1 (not a storm). last_ok **88 locked** (extra-P1 stay locked).
  ...
  - **Gate 94 FAIL** `worst=0.69@DV` (MV ×1.02/@H ×1.10; DV ×0.69/@H ×0.79; spread×6.1 signflips=3 `not_noisy=False`) on detonated weights. EXTEND to 904752 (cap 929884 → next gate ~104).
  - Iter 96 recovering recon 0.044 skip 1. `wm_best` @80 gain_fid 0.913. GPU ~11 GB. Do **not** score `bc_mean_only`. Extra P1 FALSIFIED as DV lever (P41).
