...
- **LIVE (2026-08-28 ~02:00, iter 24, pid 4176670, `73a5116`):** device=cuda bs=128 det+eager. recon 0.084→**0.0034**, gmatch **0.0002** (n=2) from iter 1 (P39 iter-1 gmatch 1.17 — isolation no longer fights FD). iso/ss **0**. skip 0. t_wm **~99 s** (P39 ~128 s). Iter-10 probe H=55 r=0.594 `gain_fid=0.903`. Wrap gnorm ~22 at 6/11/18/24 recover (do not lower skip). GPU ~17 GB. **No second GPU job.**
