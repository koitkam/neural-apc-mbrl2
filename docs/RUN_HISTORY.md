...
- **Liveness:** live. GPU occupied (~15.7 GB). tmux `mbrl2_p43`, pid **4465**, launch `51b0f45`. Env-free. `huber_per_in=True` β_mv=**2.63** β_dv=**0.512**. **Do not launch a second GPU job.**
