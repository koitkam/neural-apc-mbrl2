...
| P55 | 2026-08-30 | PPO μ-ratio recopy every P3 iter (`p3_mu_ratio_refresh_iters=1`) | LIVE env-free `run_p55_murefresh` pid **103504** sha `b321d89`. **P3** after **GAIN-READY @82** 0.88@DV last_ok **82**. Unfreeze 147: logp_std 0.67→**18.8@175** still ~9–10; `clip_frac` 0.02–0.80 (moving ball); ema **−170→−2000**; vs_expert **−2200**; rtgt 0.060→**0.0001**; rscale **1.91 KEEP**. Rest-IC CUDA-graph fail this pid (`t_wm` ~127 s). Not KEEP until EXIT+val. | LIVE |
