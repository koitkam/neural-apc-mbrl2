...
- **P2 iter 133 (~209 min):** recon **0.0021** bc MSE **0.002** skip **0** last_ok **78 unlocked** dobg ~0.009. Iter 120 `wm_best` EMA **6.293** gain_fid=0.973. Iter 130 wm-fid H=55 r=**0.262** best_h=13 **gain_fid=0.441** (dip vs 120, no new best). t_iter ~27 s. Unfreeze ~147 (~6 min, 14 iters).
